...
export const createTeam = async (name: string, members: string[]) => await Team.populated(await teamRepository.createAndSave({ name, members }))

export const getTeamById = async (id: string) => await Team.populated(await teamRepository.fetch(id));
